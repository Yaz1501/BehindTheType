...
comments: true
---
Typography is used everywhere in many different ways, we see it from the moment we wake to the time we go to bed. Most of the time we do not even notice it and its styles, but typography is an essential element of everyday life. However, whether it is in print or on screen, fonts and typefaces are processed and used differently.
...
The use of serif fonts was widespread in the 19th century with advertising. The industry needed fonts that could be seen from a far distance, make an impact on the viewer, and be different from whatever random information they could read.
